...
Search Operation:
The method starts at the beginning of the string and looks for the first occurrence of the substring "world".
It scans the string and finds that the substring "world" starts at index 6.
'''